...
def get_activities(
    ...
    - difficulty: Filter by difficulty level ('Beginner', 'Intermediate', 'Advanced').
                  When a difficulty is specified, activities with no difficulty set are also included
                  since they are suitable for all levels. When no difficulty is specified, all
    ...
    if difficulty:
        ...
        # All top-level conditions are implicitly AND-ed by MongoDB.
        query["$or"] = [
